...
const Stars = () => {
    const star1 = {num: 1, isHovering: false, isClicked: false}
    const star2 = {num: 2, isHovering: false, isClicked: false}
    const star3 = {num: 3, isHovering: false, isClicked: false}
    const star4 = {num: 4, isHovering: false, isClicked: false}
