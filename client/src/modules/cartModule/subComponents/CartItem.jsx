...
const CartItem = ({data}) => {
  ...
  return (
    <tr>
          ...
          className='w-fit h-fit border-[1px] border-gray-300 lg:p-5 cursor-pointer px-3 xl:translate-x-[25%]'>X</td>
          <td className='border-[1px] border-gray-300 lg:w-32'>
            <img src={data?.mainImg} alt="" className='w-32'/>
          </td>
          <td className='w-fit h-fit border-[1px] border-gray-300 lg:p-5 xl:translate-x-[25%]'>{data?.title}</td>
          <td className='w-fit h-fit border-[1px] border-gray-300 lg:p-5 xl:translate-x-[25%]'>${data?.price.toFixed(1) + '0'}</td>
          <td className='lg:p-5 md:h-[10.1rem] h-20 border-b-[1px] border-gray-300 flex justify-center items-center'>
          ...
          <td className='w-fit h-fit border-[1px] border-gray-300 lg:p-5 xl:translate-x-[25%]'>${(data?.price * data?.chosenAmount).toFixed(1) + '0'}</td>
    </tr>
  )
}
