...
const categories = dataCategories.map((el, idx) => 
    <div className='cursor-pointer lg:flex-1 duration-500 rounded-xl h-56 hover:shadow-xl flex flex-col items-center justify-around group/edit' style={{backgroundColor: el.color}} key={idx}>
